        ...
        <section class="categories_product_main p_80">
            <div class="container" style="max-width: unset;">
                <div class="col-lg-12" style="padding: 0; text-align:center;">
                    <h1 style="margin:0; padding-bottom: 40px; color: #09366C; font-weight: bold; text-align:left;"> Bestellingen beheren </h1>
                </div>
                        ...
                        <div class="col-lg-3 float-md-left">
                            <div class="categories_sidebar">
                                <aside class="l_widgest l_color_widget">
                                        ...
                                        <a href="bestellingenbeheren.php" style="text-decoration: underline;">Bestellingen</a> <br>
